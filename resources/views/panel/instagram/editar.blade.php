        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmEditar" autocomplete="off">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="idinstagram" id="idinstagram" required>
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group">
                                <label for="linkEditar">Link: <span class="text-danger">(*)</span></label>
                                <input type="text" name="linkEditar" id="linkEditar" required class="form-control"  placeholder="https://www.instagram.com/p/...">
                            </div>
                        </div>
