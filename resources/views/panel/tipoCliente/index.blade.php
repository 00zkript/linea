            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header" style="background-color: #2a3f54">
                         <p style="font-size: 20px" class="card-title text-center text-white mb-0"> Gestionar Tipo de cliente</p>
                    </div>
                    <div class="card-body">
                        <div class="row">
...
@push('js')
    <script type="module" >
        ...
        const URL_LISTADO     = "{{ route('tipoCliente.listar') }}";
        const URL_GUARDAR     = "{{ route('tipoCliente.store') }}";
        const URL_VER         = "{{ route('tipoCliente.show',':id') }}";
        const URL_EDIT        = "{{ route('tipoCliente.edit',':id') }}";
        const URL_MODIFICAR   = "{{ route('tipoCliente.update',':id') }}";
        const URL_HABILITAR   = "{{ route('tipoCliente.habilitar',':id') }}";
        const URL_INHABILITAR = "{{ route('tipoCliente.inhabilitar',':id') }}";
        const URL_ELIMINAR    = "{{ route('tipoCliente.destroy',':id') }}";
