                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 form-group">
                            ...
                            <textarea class="form-control" name="descripcion" id="descripcion" placeholder="Descripción" rows="5" ></textarea>
                        </div>

                        <div class="col-12 form-group">
                            <label for="contenido">Contenido:</label>
                            <textarea class="form-control" name="contenido" id="contenido" placeholder="Contenido" rows="5" ></textarea>
                        </div>
                        ...
                        <div class="col-12 form-group">
                            ...
                            <textarea class="form-control" name="direccion" id="direccion" placeholder="Dirección" rows="5" ></textarea>
                        </div>

                        <div class="col-12 form-group">
                            <label for="horarioAtencion">Horario atención</label>
                                <textarea class="form-control" name="horarioAtencion" id="horarioAtencion" placeholder="Horarion atención" rows="5" ></textarea>
                        </div>
