        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmEditar" autocomplete="off">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="idcantidad_clases" id="idcantidad_clases" required>
                    <div class="row">
                        ...
                        <div class="col-12 form-group">
                            ...
                            <input type="text" name="cantidadEditar" id="cantidadEditar" required class="form-control format-number"  placeholder="Cantidad">
                        </div>
                        ...
                        <div class="col-12 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control format-number-price" name="precioEditar" id="precioEditar" placeholder="Precio" >
                            </div>
                        </div>
