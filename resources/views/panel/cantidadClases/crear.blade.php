                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 form-group">
                            ...
                            <input type="text" name="cantidad" id="cantidad" required class="form-control format-number"  placeholder="Cantidad">
                        </div>
                        ...
                        <div class="col-12 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control format-number-price" name="precio" id="precio" placeholder="Precio" >
                            </div>
                        </div>
