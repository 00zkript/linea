        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmEditar" autocomplete="off">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="idtemporada" id="idtemporada" required>
                    <div class="row">
                        ...
                        <div class="col-12 form-group">
                            <label for="fechaDesdeEditar">Fecha desde: <span class="text-danger">(*)</span></label>
                            <input type="text" name="fechaDesdeEditar" id="fechaDesdeEditar" required class="form-control datepicker"  placeholder="Fecha desde">
                        </div>

                        <div class="col-12 form-group">
                            <label for="fechaHastaEditar">Fecha hasta: <span class="text-danger">(*)</span></label>
                            <input type="text" name="fechaHastaEditar" id="fechaHastaEditar" required class="form-control datepicker"  placeholder="Fecha hasta">
                        </div>
