...
@section('meta')
    ...
    <meta property="og:title" content="TERMINOS Y CONDICIONES | {{ $seoGeneral->titulo_general }}"/>
    ...
    <meta name="twitter:title" content="TERMINOS Y CONDICIONES | {{ $seoGeneral->titulo_general }}" />
    ...
    <div class="container mt-5 mb-md-6 mb-4">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12 mb-4">
                <h2 class="fw-bold text-center text-uppercase">Términos y condiciones</h2>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                {!! $terminosCondiciones->contenido !!}
            </div>
        </div>
    </div>
@endsection
